...
export default {
  ...
  getDataset(){
            getRequest('admin/mining/getDataByDisease/'+this.chooseDisease).then(
                (response) => {
                  console.log( this.chooseDisease)
  ...
  methods: {
        ...
        if (this.m_dataDisList.findIndex(item=>item== "多疾病") != -1) {
          ...
          this.$message({
            ...
            getRequest('admin/mining/getDataByDisease/'+this.chooseDisease).then(
                (response) => {
                  console.log(this.chooseDisease)
               //   this.$router.push({ path: '/mining/DataSelect', query: { selectedValue: this.chooseDisease } });
    ...
    next(dataname) {
      ...
      this.m_changeStep(2);
      this.$router.push({ path: '/mining/DisFactor', query: { selectedValue: this.chooseDisease } });
    },
  },
};
</script>
