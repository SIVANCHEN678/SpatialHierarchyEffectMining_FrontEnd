<template>
  <div> 
    <div>
      <div class="left_tree">
       <h2 style="margin-left: 20%;">选择数据集</h2>
<div style="margin-top: 20px;">
      ...
      <div class="right_table">
          ...
          <div style="margin-left: 50%;">  <h3>数据集信息</h3></div>
...
export default {
  ...
  methods: {
    ...
    city(){
     ...
     console.log(this.showDataForm.classPath,'this.showDataForm.classPath')

      const containsDataset = this.showDataForm.classPath.includes("公开数据集");
...
if(containsDataset===true){
 ...
 getRequest("/admin/api/getDataType", {
    ...
    getTableDescribe(id){
      getTableDes("/admin/api/tableDescribe").then(response=>{
