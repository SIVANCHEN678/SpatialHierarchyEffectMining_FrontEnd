<template>
  <div v-loading="loading" element-loading-text="拼命运算中">
    <el-container>
      <el-tabs id="modelList"  @tab-click="onTabClick" v-model="model" tab-position="left">
        <!-- tab-pane的name值必须与vuex里的算法名字一一对应 -->


        <el-tab-pane v-for="(tab, index) in tabPages" :key="index" :label="tab.algorithmName" @click="onTabClick">
            ...
            >
              ...
              <el-form-item prop="K_and_SP">
                <template slot="label">
                  ...
                  <el-popover placement="right" trigger="hover">
                    <div>
                      根据数据的类型选择合适的算法参与运算，对于fges算法运算速度较快，算法只能处理数值类型的数据
                    </div>
                    <el-icon
                      slot="reference"
                      class="el-icon-warning-outline"
              ...
              <el-form-item prop="K_and_PC">
                <template slot="label">
                  ...
                  <el-popover placement="right" trigger="hover">
                    <div>
                      设置最大节点度数，即在搜索过程中允许的最大边数量，默认为0.3
                    </div>
                    <el-icon
                      slot="reference"
                      class="el-icon-warning-outline"
