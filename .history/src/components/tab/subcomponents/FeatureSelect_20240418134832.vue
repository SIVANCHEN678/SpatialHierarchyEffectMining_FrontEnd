<template>
  ...
  <el-checkbox-group v-model="selectedFeatures">
    <div v-for="item in selectedFeatures" :key="item">
      <el-checkbox :label="item">
        {{ findItemLabel(item) }} <!-- 使用findItemLabel方法查找对应的特征名称 -->
        <el-progress
...
export default {
  ...
  handleCheckAllChange(val) {//这是全选的
      ...
      this.selectdata=this.columnSelectForm.formData.selectedData
