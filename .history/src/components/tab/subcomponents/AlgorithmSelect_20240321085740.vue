      ...
      <el-tabs id="modelList" v-model="model" tab-position="left">
        ...
        <el-tab-pane v-for="(tab, index) in tabPages" :key="index" :label="tab.algorithmName" >
          ...
          <div class="introBox">
           ...
           <!-- 在标签页中添加表单项 -->
           <el-form :model="tabFormData" class="form">
            <el-form-item label="任务类型">
              <el-select v-model="tabFormData.type" placeholder="请选择任务类型">
                <el-option label="空间层次效应挖掘" value="she_mining"></el-option>
                <el-option label="临床表征-疾病危险因素因果关系挖掘" value="clinical_features_mining"></el-option>
              </el-select>
            </el-form-item>
            
            <el-form-item label="任务描述">
              <el-input v-model="tabFormData.description"></el-input>
            </el-form-item>
            
            <el-form-item label="算法选择">
              <el-select v-model="tabFormData.algorithmId" placeholder="请选择算法">
