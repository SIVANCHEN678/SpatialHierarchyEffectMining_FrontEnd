...
searchAll () {
 ...
 //提交整个任务
      ...
      this.form.diseaseName = this.chooseDisease //疾病名字
      this.form.tableName = this.dataSelectForm.formData.selectedData; //选择的哪个表名
      ...
      this.from.clinicalRepresentation=this.all.m_clinic;
      this.from.livingHabit=this.all.m_living;
      this.from.socialConnection=this.all.social;
      this.from.leader=this.all.principal;
      this.from.participant=this.all.participants;
      this.from.name=this.all.taskName;
      this.from.description=this.all.label
