           ...
           <div class="paramBox">
            ...
            >
              <el-form-item prop="K_OR">
                ...
                <el-input v-model.trim="SF_DRMB_form.K_OR"><span class="lineStyle">▍</span>空间层次选择</el-input><!--空间层次-->
              ...
              <el-form-item prop="K_and_SP">
                ...
                <el-input v-model.trim="SF_DRMB_form.K_and_SP" style="margin-top: 10px;"></el-input>
                <span class="valueRange"></span>
              </el-form-item>
            </el-form>
            <div class="buttonBox">
