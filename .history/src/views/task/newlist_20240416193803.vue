  ...
  <div class="main"> 
    <div class="left_tree">
      ...
      <div id="top_buttons">
        ...
        <el-select v-model="value1" placeholder="新建任务"  :style="{ width: '100px' }" style="background-color: #98fb98;" @change="handleChange">
    <el-option
...
//建任务
handleChange(value1) {
      console.log('选择了:', value1);
      
      // 根据选中的value执行相应的点击事件逻辑
      switch (value) {
        case '1':
          // 对应点击事件逻辑1
          break;
