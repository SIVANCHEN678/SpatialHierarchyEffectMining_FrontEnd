<template>
  <div class="main"> 
    <div class="left_tree">
      ...
      <span class="lineStyle" style="margin-left: 20%;margin-bottom: 5%;"></span><span><b>历史任务查看</b></span>
      ...
      <div id="top_buttons">
        <div id="task_leader">
          <span>任务类型：</span>
          <!-- <el-select v-model="type" placeholder="请选择">//这是根据负责人筛选的
            <el-option
         ...
         <span> 任务类型：</span>  <el-input type="text" v-model="type" @keyup.enter="onSearch" :style="{ width: '200px' }" placeholder="请输入查询内容..."></el-input>
        </div>
...
async onSearch() {
      ...
      //   // 实现查询逻辑...
      // }
      this.searchObj.type=this.searchText
      this.current = 1;
     
      postRequest(`admin/mining/findMining/${this.current}/${this.limit}/${this.user.id}`,this.searchObj)
