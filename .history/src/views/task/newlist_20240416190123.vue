    ...
    <div class="left_tree">
      ...
      <div id="top_buttons">
        <div id="task_leader">
          ...
          </el-select><el-input v-model="input" placeholder="请输入内容"></el-input>
         <span> 任务名称：</span>  <el-input type="text" v-model="searchText" @keyup.enter="onSearch"  placeholder="请输入查询内容..."></el-input>
        </div>
