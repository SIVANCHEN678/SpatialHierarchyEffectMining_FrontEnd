  ...
  export default {
    ...
    methods: {
        ...
        async getAll() {
          ...
          await   postRequest('api/mining/getPie/'+this.clinicalRepresentation+'/'+this.livingHabit+'/'+this.socialConnection).then(
        (response) => {
          this.relationships = response.data
          console.log('this.relationships.临床表征',this.relationships.生活行为习惯)
