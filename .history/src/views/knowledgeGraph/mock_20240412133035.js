 ...
 * @param {*} name 
 */
export const search = (name,data1)=>{
    return new Promise((resolve,reject)=>{
        let result = []
        console.log("name", name)
        console.log("data1", data1)
        let list = data1.filter(item => item.name.toLowerCase().includes(name.toLowerCase()));
        // let list = data1.filter(item => {console.log(name);name.indexOf(name) >= 0});
