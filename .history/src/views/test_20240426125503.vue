...
console.log('this.citylist.length',this.citylist.length)
    ...
    const citys=this.citylist.shift();
    if(this.citys.length==1){
      const name=Object.keys(this.citys[0]);
      console.log("next",name[0]  );
      this.m_changeTaskInfo({ m_province:  name[0]});//直接设置
    }
    if(this.citys.length==2){
      const name1=Object.keys(this.citys[0]);
      console.log("next",name1[0]  );
      this.m_changeTaskInfo({ m_province:  name[0]});//直接设置
      const name=Object.keys(this.citys[1]);
      console.log("next",name[0]  );
    ...
    if(this.citys.length==3){
      ...
      const name2=Object.keys(this.citys[2]);
...
console.log('m_city',this.$store.state)
    },
 initCharts() {
