  ...
  export default {
    ...
    methods: {
      ...
      append() {
        ...
        addDisease("/admin/api/addFeature2", catagoryNodeJSON).then(response => {
      ...
      appendDisease() {
        ...
        let catagoryNodeJSON = JSON.stringify(catagoryNode);
        addDisease("/admin/api/appendDisease2", catagoryNodeJSON).then(response => {
          this.getCatgory(); //刷新目录结构
          console.log(response.data);
        }).catch(error => {
          alert("新增疾病目录错误" + error)
      ...
      addDisease() {
        ...
        let catagoryNodeJSON = JSON.stringify(catagoryNode);
        addDisease("/admin/api/addDisease2", catagoryNodeJSON).then(response => { //增加树结构
          this.getCatgory(); //刷新目录结构
          console.log(response.data);
        }).catch(error => {
          alert("新增疾病目录错误" + error)
      ...
      getCatgory() {
        getRequest("/admin/api/category2").then((response) => {
      ...
      addCharacteration() {
        getFetures("/admin/api/feature/getFeatures", 0).then(response => {
          console.log("特征为：");
          console.log(response.data);
        ...
        getFetures("/admin/api/feature/getFeatures", 2).then(response => {
          console.log("特征为：");
          console.log(response.data);
        ...
        getFetures("/admin/api/feature/getFeatures", 3).then(response => {
          console.log("特征为：");
          console.log(response.data);
      ...
      getTableData(tableId, tableName) {
        getTableData("/admin/api/getTableData", tableId, tableName)
          .then((response) => {
            // 获取表数据
      ...
      changeData(...theArgs) {
        ...
        if (theArgs[0].isLeafs == 1) {
          postRequest("/admin/filed/getAllFiled", { diseaseName: disease }).then((res) => {
            console.log(res);
