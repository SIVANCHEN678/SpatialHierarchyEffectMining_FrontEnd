...
console.log(this.provinces[0].name,'this.hostypeList')
    ...
    async fetchCities() {
      this.$emit('provinceSelected', this.getProvinceName(this.selectedProvince));
     
      this.$emit('provinceSelected', this.selectedProvince);
...
console.log(this.cities[0].name,'this.cities')
  ...
  console.log(this.districts[0].name,'this.cities')
    ...
    districtChanged() {
    this.$emit('districtSelected', this.selectedDistrict);
  },
  }
};
</script>
