...
<div ref="ct" style="width: 100%; height: 100%; display: flex; flex-direction: column; justify-content: space-between;">
  <!-- 将原本位于中间的标题和按钮内容放入一个新的Flex容器中，并设置为顶部对齐 -->
  <div style="display: flex; flex-direction: column; align-items: flex-start;">
    <h1 style="margin-top: -1%; font-size: 25px; color: #36bf36;">选择展示因果关系的地区</h1>
    <!-- 将按钮放在标题旁边，通过margin调整间距 -->
    <div style="display: flex; align-items: flex-start;">
      <el-button @click="next()" type="primary" style="margin-top: 1%; margin-bottom: auto;">确认当前选择地区</el-button>
      <!-- 注释掉了back按钮，如果需要可以取消注释并调整样式 -->
      <!-- <el-button @click="back()" type="primary" style="margin-top: 1%;">上一步</el-button> -->
    </div>
  </div>
  ...
  <div v-if="currentClickedCity" class="zi" style="margin-left: 1%; margin-top: -205;">
