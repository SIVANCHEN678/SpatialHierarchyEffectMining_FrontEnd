    ...
    <div class="bottom">
      <div class="left">
        <div class="home-filter-wrapper">
          <div class="title"> 选择展示因果关系的地区</div>
          <div>
            <div class="filter-wrapper">
              <span class="label">省市：</span>
              <div class="condition-wrapper">
                <span class="item v-link clickable" :class="hostypeActiveIndex == index ? 'selected' : ''" v-for="(item,index) in hostypeList" :key="item.name" @click="hostypeSelect(item.value, index)">{{ item.name }}</span>
              </div>
            </div>
            <div class="filter-wrapper">
...
console.log(this.hostypeList,'this.hostypeList')
