<template>
  ...
  <div ref="ct" style="width: 100% ; height: 800px;" class="chinaMapBox">
    <el-button @click="next()" type="primary" style="margin-top: 20px;">确认</el-button>
...
export default {
  ...
  methods: {
    ...
    //this.citylist.push(this.currentClickedCity)
      console.log("next", Object.keys(this.citylist)[0]);
      this.m_changeTaskInfo({ m_province:  Object.keys(this.lastCity)[0] });//直接设置
