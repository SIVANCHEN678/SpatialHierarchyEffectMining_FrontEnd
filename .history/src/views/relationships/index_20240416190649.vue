<template>
  <div class="app-container">
    ...
    <div class="left_tree">
      <el-button type="success" style=" margin-bottom: 5%;" >点击病种查看相关知识图谱关系      </el-button>
    ...
    <el-row :gutter="20">
      <el-col :span="6" v-for="(item,index) in list1" :key="index" style="margin-bottom: 10px;margin-left: 35px; width: 350px;height: 120px;">
        <el-card body-style="padding: 10px; height: 100px;   ">
          ...
          <el-button type="danger" icon="el-icon-delete" @click="deleteTable(item)" size="small" class="link-left" style="margin-top: 20px;"></el-button>
        </el-card>
      </el-col>
    </el-row>
    <!-- 分页 -->
