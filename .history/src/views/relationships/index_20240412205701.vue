<template>
  <div class="app-container">
    ...
    <div class="left_tree">
      <el-button type="success" style="margin-left: 5%; margin-bottom: 1%;" >      点击疾病名称查询历史任务      </el-button>
      <el-tree
        ref="tree"
        :data="treeData"
        :show-checkbox="false"
...
<div class="abc">
  ...
  <div class="horizontal-line"></div>
    ...
    <el-row :gutter="20">
      <el-col :span="6" v-for="(item,index) in list1" :key="index" style="margin-bottom: 10px;margin-left: 35px; width: 350px;height: 300px;">
...
console.log(resultArray);
    ...
    .card-item {
      width: 200px; /* 设置方块的宽度 */
      height: 80px; /* 设置方块的高度 */
      margin-bottom: 1px; /* 设置方块之间的底部外边距 */
    }
    .link-left {
