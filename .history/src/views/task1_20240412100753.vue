          ...
          series: [
            {
              ...
              data: [
                { value: this.relationships.临床表征, name: '临床表征' ,itemStyle: { color: '#ff7f50' }},
                { value: this.relationships.生活行为习惯, name: '生活行为习惯',itemStyle: { color: '#ff735a' } },
                { value: this.relationships.社会环境, name: '社会环境' ,itemStyle: { color: '#7fff00' }},
