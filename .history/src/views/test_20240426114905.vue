<template>
  ...
  <div ref="ct" style="width: 100% ; height: 100%;" class="chinaMapBox">
   
    <h1 style="margin-left: 45%;margin-top: -1%; font-size: 25px; color: #36bf36;">选择展示因果关系的地区</h1>
    <div ref="charts" :style="{ height: chartsHeight }" />

    <el-button @click="next()" type="primary" style="margin-top: -20%;">确认当前选择地区</el-button>
    <!-- <el-button @click="back()" type="primary" style="margin-top: -20%;">上一步</el-button> -->
   
    <div v-if="currentClickedCity" class="zi" style="margin-left: 1%;margin-top: -10%;">
...
console.log('this.citylist.length',this.citylist.length)
    ...
    if(this.citylist.length==3){
      const name1=Object.keys(this.citylist[1]);
      console.log("next",name1[0]  );
      this.m_changeTaskInfo({ m_province:  name[0]});//直接设置
      const name=Object.keys(this.citylist[2]);
      console.log("next",name[0]  );
      this.m_changeTaskInfo({ m_city:  name[0]});//直接设置
    }
    if(this.citylist.length==4){
      const name1=Object.keys(this.citylist[1]);
      console.log("next",name1[0]  );
      ...
      const name2=Object.keys(this.citylist[3]);
