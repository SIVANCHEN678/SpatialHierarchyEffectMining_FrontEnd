    ...
    <div class="right_table">
        <el-card class="right_table_topCard">
          ...
          <div class="tableData">
            ...
            <el-table :data="tableData"  min-width="550px"  border style="width: 100%" class="custom-table">
            <el-table-column fixed :min-width="calcColumnMinWidth(tableData.length)" v-for="(value, key) in tableData[0]" :key="key" :prop="key" :label="key" width="80">
              <template slot-scope="{ row }">
                <div class="truncate-text">{{ row[key] }}</div>
              </template>
            </el-table-column>
