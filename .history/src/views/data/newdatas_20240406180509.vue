        ...
        <el-card class="right_table_topCard">
          <div class="describe_content">
            ...
            <p style="margin-top:0.5%">
              ...
              <i ></i>特征列: <span>{{allColumns.length}}列</span>
            </p>
...
//   getTableData("/admin/api/getTableData1",  this.dataid, this.datalable).then(response => {
//     // 获取表数据
...
//   // 使用FileSaver或者其他兼容的方式保存文件
//   FileSaver.saveAs(blob, 'selected_data.xlsx');
// }).catch(error => {
//   console.error(error);
// });
...
,
    ...
    getTableDescribe(id, label){
      ...
      getTableDes("/admin/api/tableDescribe",id).then(response=>{
        ...
        this.showDataForm.classPath = response.classPath;
      })
      .catch(error=>{
