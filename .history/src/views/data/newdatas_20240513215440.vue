<template>
  <div class="content">
        ...
        <el-tree ref="tree1" :data="treeData1" :show-checkbox="false" node-key="id" :default-expanded-keys="['1']"
          ...
          node.label }}
            ...
            <span>
              ...
              <el-popconfirm v-if="data.label == '多疾病'" confirm-button-text="上传数据集" title="请上传本地多疾病数据集" @confirm="importData">
                <el-button v-if="data.catLevel != 1 && data.status != 2 && data.isLeafs == 0"
                  icon="el-icon-circle-plus-outline" size="mini" type="text" slot="reference" @click="markNode(data)">
                </el-button>
              </el-popconfirm>
    ...
    <!--===============================     添加数据表单   ===================================================================-->
    <el-dialog v-loading="loading" :element-loading-text="loadText" id="importDataTable" title="导入数据表AAAA"
