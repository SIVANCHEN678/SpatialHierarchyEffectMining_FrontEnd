<template>
  <div>
    <div class="left_tree">
      <div slot="header" class="clearfix" style=" margin-left: 30%;">
          <span class="lineStyle">▍</span><span>可选数据</span>
        ...
        </div><p>总共有{{totalPrimaryDiseases }}个一级病种,{{totalDatasets }}个数据集</p>
      <el-button type="success" class="add_button" @click="dialogDiseaseVisible2 = true">添加病种</el-button>专病数据集
      <el-dialog
        title="提示"
