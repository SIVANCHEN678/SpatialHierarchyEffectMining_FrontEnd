<template>
  <el-row :gutter="40" class="panel-group">
    ...
    <el-col :span="8" >
      <el-card>
        <div slot="header" class="clearfix">
        <span class="lineStyle">▍</span><span>知识库</span></div>
        <!-- <TaskCountChart :taskData="formattedChartData" /> -->
          <Charts style="width: 100%; height: 400px;background-color:darkkhaki;" ></Charts>
...
<script>
import Charts from '../../views/knowledgeGraph/KnowledgeGraph.vue' // 替换为你的Charts组件的实际路径
