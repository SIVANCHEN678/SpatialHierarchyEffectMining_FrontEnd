    ...
    <el-col :span="8" >
      ...
      <div slot="header" class="clearfix">
          ...
          <div id="chartBox" style="height: 300px;width: 500px;">
            <LineChartVue  :legend="chartLegend" :statistic="chartData" :x="sevendays">
            </LineChartVue>
          </div>
        </el-card> -->
    </el-col>
...
export default {
  ...
  methods: {
    ...
    changeChart() {
      ...
      switch (this.charttype) {
        ...
        case 1: {
          ...
          console.log('this.taskTotal',this.taskTotal)
          this.chartData = this.taskTotal;
          console.log('加入的',this.chartData)
          break;
        }
        case 2: {
    ...
    //     for (let i = 0; i < 7; i++) {
    //       this.formattedChartData.formattedDate.push(res[i].formattedDate);
    //       this.formattedChartData.total.push(res[i].total);
