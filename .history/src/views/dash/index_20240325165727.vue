<template>
  <el-row :gutter="40" class="panel-group">
    ...
    <el-col :span="8" >
      <el-card>
        <div slot="header" class="clearfix">
          <span class="lineStyle">▍</span><span>数据集统计</span>
        </div>
...
export default {
  ...
  methods: {
    ...
    getInitInfo() {
      getRequest("admin/stastic/get_all_table_names").then(
        (res) => {
          if (res.code == 200) {
      ...
      // getRequest("admin/stastic/getStasticOne").then(
      //   (res) => {
      //     if (res.code == 200) {
  ...
  xAxis: {
    type: 'category',
    data: ['M3-16', '3-17', '3-18', '3-19', '3-20', '3-21', '3-22']
  },
  yAxis: {
    type: 'value'
  },
