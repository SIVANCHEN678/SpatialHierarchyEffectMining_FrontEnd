<template>
  <el-row :gutter="40" class="panel-group">
    ...
    <el-col :span="8" >
      <el-card>
        <div slot="header" class="clearfix">
          <span class="lineStyle">▍</span><span>各病种因果知识库</span>
        </div>
        <Charts style="width: 100%; height: 400px; margin-left: -50px;" ></Charts>
    ...
    <el-col :span="8" >
      <el-card>
        <div slot="header" class="clearfix">
        <span class="lineStyle">▍</span><span>数据</span></div>
    ...
    drawChart2() {
      ...
      option = {
        ...
        formatter: function (value) {
          return Math.floor(value); // 格式化刻度值，只显示整数部分
        },
        interval: 1  // 设置刻度间隔为1}
