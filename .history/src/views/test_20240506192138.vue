...
back1(){
  ...
  this.$router.push('/DisFactor')
    ...
    next(){
console.log('this.citylist.length',this.currentClickedCity)
      ...
      console.log('this.citylist.length',this.citylist)

      this.citylist.shift()
      console.log('this.citylist.length11',this.citylist)
    ...
    if(this.citylist.length==3){
      ...
      const name2=this.citylist[2];
      console.log("next",name2  );
      this.m_changeTaskInfo({ m_county:  name2});//直接设置
    }
