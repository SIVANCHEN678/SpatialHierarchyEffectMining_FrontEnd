...
<div v-if="active==1" >
  ...
  <el-row :gutter="20">
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="8">
        <div class="checkbox-container">
          <el-tooltip effect="light" content="全选" placement="top">
            <el-checkbox v-model="checkAllDemoOptions" @change="handleCheckAllChange('demoOptions')" border>
              全选
            </el-checkbox>
          </el-tooltip>
        </div>
    ...
    <el-row :gutter="20">
      <h5 class="text" style="font-size: 20px; font-weight: bold;">
        <span class="lineStyle">▍</span>社会环境指标
      </h5>
      <el-col v-for="item in sociolOptions" :key="item.columnName" :span="8">
        <div v-if="item.columnisX" class="checkbox-container">
          <el-tooltip effect="light" :content="item.columnDesc" placement="top">
            <el-checkbox class="radio" v-model="checkedSociolOptions" :label="item.columnName" border>
              {{ item.columnName }}
            </el-checkbox>
          </el-tooltip>
        </div>
      ...
      <el-col :span="8">
        <div class="checkbox-container">
          <el-tooltip effect="light" content="全选" placement="top">
            <el-checkbox v-model="checkAllSociolOptions" @change="handleCheckAllChange('sociolOptions')" border>
              全选
            </el-checkbox>
          </el-tooltip>
        </div>
    ...
    <el-row :gutter="20">
      <h5 class="text" style="font-size: 20px; font-weight: bold;">
        <span class="lineStyle">▍</span>生活行为习惯指标
      </h5>
      <el-col v-for="item in physioOptions" :key="item.columnName" :span="8">
        <div v-if="item.columnisS" class="checkbox-container">
          <el-tooltip effect="light" :content="item.columnDesc" placement="top">
            <el-checkbox class="radio" v-model="checkedPhysioOptions" :label="item.columnName" border>
              {{ item.columnName }}
            </el-checkbox>
          </el-tooltip>
        </div>
      ...
      <el-col :span="8">
        <div class="checkbox-container">
          <el-tooltip effect="light" content="全选" placement="top">
            <el-checkbox v-model="checkAllPhysioOptions" @change="handleCheckAllChange('physioOptions')" border>
              全选
            </el-checkbox>
          </el-tooltip>
        </div>
...
import { validAlphabets } from '@/utils/validate';
  export default {
      ...
      physioOptions: [],
      checkedDemoOptions: [],
      checkedSociolOptions: [],
      checkedPhysioOptions: [],
      checkAllDemoOptions: false,
      checkAllSociolOptions: false,
      checkAllPhysioOptions: false,
            demoOptions: [
        { columnName: 'Option 1', columnDesc: 'Description 1', columnisR: true },
        { columnName: 'Option 2', columnDesc: 'Description 2', columnisR: true },
        { columnName: 'Option 3', columnDesc: 'Description 3', columnisR: true },
      ],checkedDemoOptions: [],
      ...
      methods: {
        ...
        handleCheckAllChange(optionType) {
      switch (optionType) {
        case 'demoOptions':
          this.checkedDemoOptions = this.checkAllDemoOptions ? this.demoOptions.map(item => item.columnName) : [];
          break;
        case 'sociolOptions':
          this.checkedSociolOptions = this.checkAllSociolOptions ? this.sociolOptions.map(item => item.columnName) : [];
          break;
        case 'physioOptions':
          this.checkedPhysioOptions = this.checkAllPhysioOptions ? this.physioOptions.map(item => item.columnName) : [];
          break;
        default:
          break;
      }
