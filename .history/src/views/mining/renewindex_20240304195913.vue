    ...
    >
      ...
      >
        ...
        <el-row :gutter="10">
          ...
          <el-col v-for="item in demoOptions" :key="item.columnName" :span="6">
        ...
        <el-row :gutter="10">
          ...
          <el-col v-for="item in sociolOptions" :key="item.columnName" :span="6">
        ...
        <el-row :gutter="10">
          ...
          <el-col v-for="item in physioOptions" :key="item.columnName" :span="6">
...
.checkbox-wrapper {
  margin-bottom: 10px; /* 设置复选框全选的底部间距 */
}
.text {
  margin-bottom:200px; /* 设置每个指标标题的底部间距 */
}
