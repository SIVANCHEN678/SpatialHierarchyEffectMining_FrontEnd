    ...
    >
      ...
      >
        ...
        <el-row :gutter="60">
          ...
          <el-col v-for="item in demoOptions" :key="item.columnName" :span="7">
        ...
        <el-row :gutter="60">
          ...
          <el-col v-for="item in sociolOptions" :key="item.columnName" :span="7">
        ...
        <el-row :gutter="60">
          ...
          <el-col v-for="item in physioOptions" :key="item.columnName" :span="7">
