      ...
      <div class="mainform">
        ...
        >
          ...
          >
            <!-- 临床表征指标 -->
            <el-row :gutter="20">
          <h5 class="text" style="font-size: 16px; font-weight: bold;">临床表征指标</h5>
          <el-col v-for="item in demoOptions" :key="item.columnName" :span="8" style="margin: 8px;">
            ...
            <!-- 社会环境指标 -->
            <el-row :gutter="20">
          <h5 class="text" style="font-size: 16px; font-weight: bold;">社会环境指标</h5>
          <el-col v-for="item in sociolOptions" :key="item.columnName" :span="8">
            ...
            <!-- 生活行为习惯指标 -->
            <el-row :gutter="20">
          <h5 class="text" style="font-size: 16px; font-weight: bold;">生活行为习惯指标</h5>
