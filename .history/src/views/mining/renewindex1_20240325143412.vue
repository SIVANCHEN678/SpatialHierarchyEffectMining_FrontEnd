    ...
    <div v-if="active == 1">
        ...
        <div class="right_table">
              ...
              <div class="center" style="font-size: 16px;">
                <el-button @click="backStep()" round>上一步</el-button><el-button @click="next()" round>下一步</el-button>
      ...
      console.log(this.demoOptions)
          ...
          if(this.active === 0){
           this. dialogDiseaseVisible2=false;
            ...
            console.log('this.taskInfoForm.disease',this.taskInfoForm.disease)
