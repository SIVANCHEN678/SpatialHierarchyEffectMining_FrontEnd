  ...
  <div class="app-container"  >
    ...
    >
      ...
      <div v-if="active == 1" >
        ...
        <el-form-item label="选择属性列：" prop="selectedData" style="margin-bottom: 1px;">
          <el-checkbox :indeterminate="isIndeterminate" v-model="checkAll"  style="margin-top: -45px;margin-left: 100px;" @change="handleCheckAllChange">全选</el-checkbox>
        </el-form-item>
          <el-checkbox-group
      ...
      > 
        ...
        <el-row :gutter="60">
          ...
          <el-col v-for="item in demoOptions" :key="item.columnName" :span="9">
            <div v-if="item.columnisR">
              <el-tooltip effect="light" :content="item.columnDesc" placement="top">
                <el-checkbox class="radio" :label="item.columnName" border>{{ item.columnName }}</el-checkbox>
              </el-tooltip>
            </div>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="60">
          ...
          <el-col v-for="item in sociolOptions" :key="item.columnName" :span="9">
        ...
        <el-row :gutter="60">
          ...
          <el-col v-for="item in physioOptions" :key="item.columnName" :span="9">
