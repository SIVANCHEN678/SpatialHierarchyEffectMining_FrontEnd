  ...
  <div class="app-container"  >
    ...
    >
      ...
      <div v-if="active == 1" >
        ...
        <el-form-item label="选择属性列：" prop="selectedData" style="margin-bottom: 10px;">
          <el-checkbox :indeterminate="isIndeterminate" v-model="checkAll"  style="margin-top: 10px;margin-left: 40px;" @change="handleCheckAllChange">全选</el-checkbox>
        </el-form-item>
          <el-checkbox-group
