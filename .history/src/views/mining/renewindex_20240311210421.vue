<template>
  <div class="app-container"  >
      ...
      <div v-if="active == 0">
        ...
        width="30%">
        <span>
          <h5  style="font-size: 20px; font-weight: bold; margin-bottom: 10px;"> 至少选择一个地区</h5> 
    ...
    >
      ...
      <div class="mainform">
        ...
        <el-form-item
          label="选择属性列："
          prop="selectedData"
          style="margin-bottom: 1px; font-size: 50px; font-weight: bold;"
        >
          <el-checkbox
            :indeterminate="isIndeterminate"
            v-model="checkAll"
            style="margin-top: -53px; margin-left: 100px; font-size: inherit; font-weight: inherit;"
          ...
          >
            <!-- 临床表征指标 -->
            <el-row :gutter="20">
          <h5 class="text" style="font-size: 20px; font-weight: bold;">临床表征指标</h5>
        ...
        <el-divider></el-divider>
            <!-- 社会环境指标 -->
            <el-row :gutter="20">
          <h5 class="text" style="font-size: 20px; font-weight: bold;">社会环境指标</h5>
        ...
        <el-divider></el-divider>
            <!-- 生活行为习惯指标 -->
            <el-row :gutter="20">
          <h5 class="text" style="font-size: 20px; font-weight: bold;">生活行为习惯指标</h5>
