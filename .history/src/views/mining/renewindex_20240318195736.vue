      ...
      <div v-if="active == 3">
          ...
          <div id="mainform">
            <div id="ll">
              ...
              <el-radio-button v-for="position in tabPositions" :key="position.value" :value="position.value">{{ position.label }}</el-radio-button>
            </el-radio-group>

            <el-tabs :tab-position="tabPosition" style="height: 200px" class="demo-tabs">
              <el-tab-pane v-for="tab in tabs" :key="tab.label" :label="tab.label">{{ tab.content }}</el-tab-pane>
            </el-tabs>
