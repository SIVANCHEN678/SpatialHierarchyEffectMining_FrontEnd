      ...
      <div v-if="active == 0">
          ...
          <div id="center">
            <el-button @click="resetForm('taskInfoForm')" round>重置</el-button>
              ...
              <el-button type="primary" @click="dialogDiseaseVisible2 = true ">下一步</el-button>
              <el-dialog
        title="提示"
    ...
    >
      ...
      <div class="mainform">
        ...
        >
          ...
          >
            <el-checkbox
              ...
              v-model="checkAll"
              style="margin-top: -48px;margin-left: 100px;"
          ...
          >
            <!-- 临床表征指标 -->
            <el-row :gutter="20">
          <h5 class="text" style="font-size: 25px; font-weight: bold;">临床表征指标</h5>
          <el-col v-for="item in demoOptions" :key="item.columnName" :span="8" style="width: 100px; height: 50px;" >
        ...
        <el-divider></el-divider>
            <!-- 社会环境指标 -->
            <el-row :gutter="20">
          <h5 class="text" style="font-size: 25px; font-weight: bold;">社会环境指标</h5>
          <el-col v-for="item in sociolOptions" :key="item.columnName" :span="8" style="width: 100px; height: 50px;">
        ...
        <el-divider></el-divider>
            <!-- 生活行为习惯指标 -->
            <el-row :gutter="20">
          <h5 class="text" style="font-size: 25px; font-weight: bold;">生活行为习惯指标</h5>
          <el-col v-for="item in physioOptions" :key="item.columnName" :span="8" style="width: 100px; height: 50px;">
