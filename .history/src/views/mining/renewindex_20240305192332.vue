  ...
  <div class="app-container"  >
    ...
    >
      ...
      <div v-if="active == 1" >
        ...
        <el-form-item label="选择属性列：" prop="selectedData" style="margin-bottom: 20px;">
          <el-checkbox :indeterminate="isIndeterminate" v-model="checkAll"  style="margin-top: -100px;" @change="handleCheckAllChange">全选</el-checkbox>
        </el-form-item>
          <el-checkbox-group
