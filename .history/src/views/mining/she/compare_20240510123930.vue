   ...
   <el-col :span="12">
       <el-card style="margin-right: 2%;margin-top: 10px;margin-left:2%; height: 350px;">
         ...
         <div id="mainform" font-size="60px">
             ...
             <el-checkbox-group >
               <el-checkbox v-for="causal in diff[diffFirst]" :label="causal" :key="causal">{{causal}}</el-checkbox>
           </el-checkbox-group>
     ...
     <el-card style="margin-right: 2%;margin-top: 10px;margin-left:2%; height: 350px;">
         ...
         <div id="mainform" font-size="60px">
           <!-- <el-checkbox :indeterminate="isIndeterminate" v-model="checkAll" @change="handleCheckAllChange" >全选</el-checkbox> -->
             <div style="margin: 15px 0;"></div>
             <el-checkbox-group >
               <el-checkbox v-for="causal in diff[diffSecond]" :label="causal" :key="causal">{{causal}}</el-checkbox>
           </el-checkbox-group>
