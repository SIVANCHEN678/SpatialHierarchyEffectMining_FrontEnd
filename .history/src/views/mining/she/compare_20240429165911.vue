     ...
     <div class="zhanshi"  >
      ...
      <div slot="header" class="clearfix">
        ...
        <div class="taskInfoBox dataset">
          <span class="lineStyle">▍</span><span class="featureTitle"><strong>所用数据：</strong></span>{{ xin.tableName }}
...
handleCheckAllChange(val) {
    ...
    diff1(){//关系挖掘   要从任务表中传过来from
      ...
      postRequest('/api/mining/getDifferent',{
        firstMining:this.causalOptions,
        secondMining:this.causalOptions1
      }).then(
