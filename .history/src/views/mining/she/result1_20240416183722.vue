<template>
  ...
  <div v-else>
    <el-card style="margin-right: 2%px ;height: 250px; margin-top: 30px;margin-left: 1%;">
      <div slot="header" class="clearfix">
              <span class="lineStyle">▍</span><span class="featureTitle"><strong>疾病危险因素挖掘信息</strong></span>
        ...
        <div class="taskInfoBox participants">
          <span class="lineStyle">▍</span><span class="featureTitle"><strong>参与人：</strong></span>
    ...
    <el-card style="margin-right: 20px ;height: 600px; margin-top: 50px;">
            ...
            <!-- <div id="main" style="width: 600px; height: 400px;"></div> -->
             ...
             <task1 :clinical-representation="this.form.clinicalRepresentation"
             :living-habit="this.form.livingHabit"
             :social-connection="this.form.socialConnection"/>
          </el-card> 
         </el-col>
...
created() {
  ...
  methods: {
    async getAll() {
          await   postRequest('admin/mining/getPie/'+this.form.clinicalRepresentation+'/'+this.form.livingHabit+'/'+this.form.socialConnection).then(
        (response) => {
    ...
    // const container = document.getElementById('container');
      ...
      console.log('conter',document.getElementById('container'))
      ...
      const graph = new G6.Graph({
        ...
        layout: {
          ...
          speed: 5,
          clustering: true,
          center: [width / 2 , height / 2], // 将中心位置左移200像素
...
//保存第一层
getRequest("/admin/knowledgeGraph/saveDisease2Factor/"+context+'/'+diseaseName).then(
            response =>{
...
//保存第二层
postRequest("/admin/knowledgeGraph/saveFactor2Factor/", this.requstForm).then(
            response =>{
