...
//保存第一层
postRequest("/admin/knowledgeGraph/saveDisease2Factor",{ context: context,diseaseName:diseaseName}).then(
            response =>{
...
//保存第二层
postRequest("/admin/knowledgeGraph/saveFactor2Factor/",{context:context,relations:relations,diseaseName:diseaseName}).then(
            response =>{
