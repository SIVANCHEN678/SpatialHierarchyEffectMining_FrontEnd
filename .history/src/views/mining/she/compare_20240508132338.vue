...
export default {
  ...
  //this.getImage1()
    ...
    const getAllRelationshipsPromise = this.getAllRelationships();
  const getAllRelationships2Promise = this.getAllRelationships2();
  
  Promise.all([getAllRelationshipsPromise, getAllRelationships2Promise]).then(() => {
