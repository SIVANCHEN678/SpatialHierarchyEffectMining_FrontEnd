...
//展示的数据
    ...
    save(){
      let allname= this.form.socialConnection+this.form.livingHabit+this.form.clinicalRepresentation
...
//保存第一层
postRequest("/admin/knowledgeGraph/saveDisease2Factor", allname,this.form.diseaseName).then(
            response =>{
...
//保存第二层
postRequest("/admin/knowledgeGraph/saveFactor2Factor", allname,this.causalOptions,this.form.diseaseName).then(
            response =>{
