 ...
 <div v-else>
  ...
  <el-button class="buttonGroup" type="primary" @click="exportToPDF"  >导出结果</el-button>
   ...
   <el-row :gutter="40" class="panel-group" >
     ...
     <el-button class="buttonGroup " v-if="showbutton==true" type="success" @click="dif()">不同因果关系</el-button>
   <el-row :gutter="40" class="panel-group">
 ...
 <div class="zhanshi" v-if="showbutton==false">
   ...
   <el-col :span="12">
       <el-card style="margin-right: 2%;margin-top: 10px;margin-left:2%; height: 350px;">
         <div slot="header" class="clearfix">
           <span class="lineStyle">▍</span><span class="featureTitle"><strong>查看不同的因果关系</strong></span>
         </div>
         <div>
             <!-- <el-header>
         ...
         <div id="mainform" font-size="60px">
             ...
             <el-checkbox-group >
               <el-checkbox v-for="causal in diff1" :label="causal" :key="causal">{{causal}}</el-checkbox>
           </el-checkbox-group>
     ...
     <el-card style="margin-right: 2%;margin-top: 10px;margin-left:2%; height: 350px;">
         ...
         <div id="mainform" font-size="60px">
           <!-- <el-checkbox :indeterminate="isIndeterminate" v-model="checkAll" @change="handleCheckAllChange" >全选</el-checkbox> -->
             <div style="margin: 15px 0;"></div>
             <el-checkbox-group >
               <el-checkbox v-for="causal in diff2" :label="causal" :key="causal">{{causal}}</el-checkbox>
           </el-checkbox-group>
