<template>
  ...
  <div class="zhanshi">
        ...
        <el-card style="margin-right: 20px;margin-top: 50px;height: 400px;">
          <div slot="header" class="clearfix">
        ...
        >
          ...
          <div style="padding: 14px">
            ...
            <div>
              <el-button type="text" class="button" @click="getData(item.tableName)" style="float: left; margin-left: -5px">
                数据预览
              </el-button>
