          ...
          <div id="mainform" font-size="60px">
            <el-checkbox :indeterminate="isIndeterminate" v-model="checkAll" @change="handleCheckAllChange" >全选</el-checkbox>
              ...
              <el-checkbox-group v-model="checkedRelationships" @change="handleCheckedCitiesChange">
                <el-checkbox v-for="causal in causalOptions1" :label="causal" :key="causal">{{causal}}</el-checkbox>
            </el-checkbox-group>
...
handleCheckAllChange(val) {
    ...
    diff(){//关系挖掘   要从任务表中传过来from
      
      postRequest("api/mining/getDifferent",this.causalOptions,this.causalOptions1).then(
