          ...
          series: [
            {
              ...
              data: [
                { value: this.relationships[0], name: '临床表征' ,itemStyle: { color: '#ff7f50' }},
                { value: this.relationships[1], name: '生活行为习惯',itemStyle: { color: '#ff735a' } },
                { value: this.relationships[2], name: '社会环境' ,itemStyle: { color: '#7fff00' }},
