<template>
  <div class="myMain">
    ...
    >
      <h1 class="loginTitle" style="margin-left: 20px;margin-bottom: 10px;">用户登录</h1>
      ...
      <el-form-item>
            <div style="display: flex">
              ...
              <ValidCode @input="createValidCode" style="margin-left: 5%;" />
            </div>
      </el-form-item>
      ...
      >
      <el-button
        style="width: 100%; margin-top: 20px; margin-left: 0px;background-color:#ff6347;"
...
import ValidCode from "@/views/login/ValidCode";
