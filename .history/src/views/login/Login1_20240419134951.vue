  ...
  <div class="myMain">
    <div class="mainContainer">
      ...
      <div class="rightContainer">
        <div class="loginContainer" style="margin-left: 5%;">
          <div class="myForm" >
            <el-form
            ...
            >
              <h3 class="loginTitle" style="margin-left: 30%;">软件登录</h3>
...
export default {
  ...
  data() {
    return {
      captchaUrl: `api/admin/common/kaptcha?timestamp=${new Date().getTime()}`,
      loginForm: {
        userName: "",
        password: "",
        code: "",
  ...
  methods: {
    ...
    updatecaptcha() { //修改验证码
     console.log('ssssss',new Date().getTime())
      this.captchaUrl = `api/admin/common/kaptcha?timestamp=${new Date().getTime()}`;
    ...
    submitlogin() {//登录
      this.$refs.loginForm.validate((valid) => {
        if (valid) {
          this.loading = true;
          console.log(this.loginForm,'登录的表单')
