...
export  default {
  ...
  methods:{
    load1(){
      getRequest(`/api/log/getLogByPage/${this.pageNum}/${this.pageSize}`,{params:{ userName: this.userName}})
          .then(res =>{
            console.log('查询',res)
            this.tableData = res.data.records
            console.log('查询数据',this.tableData)
    ...
    load(){
      getRequest(`/api/log/getLogByPage/${this.pageNum}/${this.pageSize}?userName=${this.userName}`,)
          .then(res =>{
            console.log('查询',res)
            this.tableData = res.data.records
            console.log('查询数据',this.tableData)
