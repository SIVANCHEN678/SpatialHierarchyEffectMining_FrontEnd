<template>
  <div class="app-container">
    ...
    <div class="card-container">
      <el-card v-for="item in list" :key="item.id" class="card-item" style="padding-top: 5px;">
        ...
        <el-button size="mini" type="danger" class="link-left" style="margin-top: 30px;" @click="deleteTable(item)">删除</el-button>
      </el-card>
    </div>
    <el-pagination
...
.card-item {
  width: 300px; /* 设置方块的宽度 */
  height: 180px; /* 设置方块的高度 */
  margin: 40px; /* 设置方块之间的间距 */
  font-size: 18px;
}
.card-container {
  display: flex;
