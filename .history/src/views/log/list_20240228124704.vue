<template>
    <div class="app-container">
      ...
      <div class="cardGroup">
        ...
        >
          <div class="cardInfo">
            <div><span class="ttl">任务ID：</span>{{ item.taskName }}</div>
            <div><span class="ttl">操作内容：</span>{{ item.leader }}</div>
            <div><span class="ttl">用户名称：</span>{{ item.disease }}</div>
            <div><span class="ttl">操作时间：</span>{{ item.model }}</div>
            <div><span class="ttl">用户IP：</span>{{ item.dataset }}</div>
