  ...
  <div class="app-container">
    ...
    <div class="card-container">
      ...
      <div >
        ...
        <p>算法名称: {{ item.algorithmName }}</p>
        <p>算法类型: {{ item.algorithmType }}</p>
        <p>算法描述: {{ item.algorithmDescription }}</p>
        <p>上传时间: {{ item.time }}</p>
        <p>最大度: {{ item.maxDegree }}</p>
        <p>评分函数: {{ item.scoreId }}</p>
