<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="参数maxdegree：">
        <el-input v-model="form.maxDegree"></el-input>
      </el-form-item>
      <el-form-item label="参数评分标准：">
...
export default {
  ...
  created() {
    ...
    this.form.scoreId = this.$route.query.row.scoreId
    this.form.maxDegree = this.$route.query.row.maxDegree
  },
  methods: {
    submitForm() {
      let _this = this
