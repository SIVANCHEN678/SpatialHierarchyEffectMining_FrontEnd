<template>
  ...
  <div class="zhanshi">
        ...
        <el-card style="margin-right: 2%;margin-top: 10px;margin-left:2%; ">
          <div slot="header" class="clearfix">
          ...
          <div id="mainform">
            ...
            <el-button type="primary" @click="save" size="mini" style="margin-left: 5%;margin-top: -2%; margin-bottom: 15px;">保存</el-button>
...
#mainform {
  ...
  align-items: flex-start; /* 根据需要可调整为center或flex-end */
  font-size: 60px;
}

/* 为了确保按钮和checkbox组在不同屏幕尺寸下都能自适应，可以对它们所在的容器稍作调整 */
