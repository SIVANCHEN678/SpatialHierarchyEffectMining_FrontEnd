...
<script>
        ...
        methods:{
            ...
            async nodeClick(params){
                ...
                if(!info.isClicked){
                    ...
                    let result = await expendNodes(info.id, this.data)
            ...
            initCharts(){
                ...
                let option = {
                    // 动画更新变化时间
                    animationDurationUpdate: 200000,                       
    ...
    nodes.forEach((item, index) => {
        ...
        const dataInfo = {
            ...
            isClicked: false,
            itemStyle: { // 设置节点样式
                color: color // 设置节点颜色为随机颜色
            },
            label: { // 设置节点标签样式
                color: '#fbd8b7' // 设置节点标签颜色为黑色
            }
        };
        data.push(dataInfo);
        if (target != item.id) {
