<template>
  <div>
    ...
    <el-button style="margin-left: 10px" @click="selectAll()">清 除</el-button>
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
                        <el-button
                            ...
                            :disabled="scope.row.catLevel<4?false:true"
                        ></el-button>
    ...
    <el-dialog title="编辑病种" :visible.sync="editDialogDiseaseVisible">
      <el-form ref="form" :model="updateDiseaseParam" :label-position="labelPosition">
        ...
        <el-form-item label="上级病种">
          <el-select v-model="updateDiseaseParam.parentDisease" :placeholder="updateDiseaseParam.parentDisease" @change="getId">
            <el-option
...
export default {
  ...
  methods: {
    ...
    updateDisease(){
      console.log("疾病名称",this.updateDiseaseParam.diseaseName)
