    ...
    <div>
        ...
        <el-card class="user_list_card">
            ...
            <el-table class="el-table" :data="displayedAdminDataManageList" stripe style="width: 100%">
                ...
                <el-table-column prop="tableId" label="数据表ID" width="200">
                </el-table-column>
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        <el-button type="primary" icon="el-icon-edit" circle
                            @click="getEditDataById(scope.row.tableId, scope.row.tableName, scope.row.tableStatus)"></el-button>
...
export default {
    ...
    methods: {
        init(){
            getRequest(`/admin/sysManage/getLevel2Label`).then(res => {
                if (res.code == 200) {
        ...
        async getLevel3ById(pid, level){
            ...
            await getRequest(`/admin/sysManage/getLabelByPid`, {
                    pid: pid
                }).then(res => {
                    if (res.code == 200) {
                        data=res.data;                       
        ...
        getAllAdminDataTable() {
            getRequest(`/admin/sysManage/selectAdminDataManage`).then(res => {
                if (res.code == 200) {
                    console.log("ret data", res.data)
        ...
        getAdminDataTableByName(type) {
            ...
            getRequest(`/admin/sysManage/selectDataByName`, {               
        ...
        const targetObject = this.disOptions.find(item => {
        ...
        if (targetObject) {
            ...
            if (targetChild) {
              diseaseName = targetChild.label;
            }
        }
        console.log("开始上传文件",diseaseName);
        ...
        deleteAdminDataManage(id, uid, tableId, tableSize, tableName) {
            ...
            getRequest(`/admin/sysManage/deleteByTableName`, {
                id: id,
                uid: uid, 
                tableId:tableId,    
                tableSize:tableSize,            
        ...
        getEditDataById(tableId, tableName, tableStatus) {
            this.oldTableName=tableName;
            this.is_cancel=tableStatus
            getRequest(`/admin/sysManage/selectDataById`, {
                tableId: tableId
            }).then(res => {
                if (res.code == 200) {
        ...
        confirmEditAdminDataManage() {
            ...
            getRequest(`/admin/sysManage/updateAdminDataManage`, {
                ...
                current_uid: sessionStorage.getItem("userid")
